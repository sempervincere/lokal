---
description: "Refactoring Specialist — Use when you need to transform poorly structured, complex, or duplicated code into clean, maintainable systems while preserving all existing behavior."
mode: subagent
